...
# project name
PROJECT_NAME=fiap-fast-food-app
...
API_GATEWAY_ID=$(aws apigatewayv2 get-rest-apis \
    --query "items[?name=='$PROJECT_NAME'].ApiId" \
    --region $AWS_REGION \
    --output text)
echo apigatewayv2 id: $API_GATEWAY_ID
...
aws lambda add-permission \
    ...
    --source-arn "arn:aws:execute-api:$AWS_REGION:$ACCOUNT_ID:$API_GATEWAY_ID/*/GET/login" \
